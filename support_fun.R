...
SNS.Rwanda.SUM_data<-read.csv("/root/data/Usecases/SNS-Rwanda/SNS-Rwanda.SUM_data.csv") 
SNS.Rwanda.O_data<-read.csv("/root/data/Usecases/SNS-Rwanda/SNS-Rwanda.O_data.csv") 
